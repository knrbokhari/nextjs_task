            ...
            <div className="grid lg:grid-cols-2 items-end lg:h-[757px]">
                <div className="">
                    ...
                    <div className='mb-[51px] flex'>
                        <button className='text-[16px] font-Poppins px-[24px] py-[16px] bg-[#264373] shadow-[0_20px_80px_rgba(51,78,123,0.3)] rounded-[10px] text-white mr-[35px] flex items-center max-w-[246px] justify-between'>Get started <IoIosArrowDroprightCircle className='h-[26px] w-[26px]' /> </button>
                        <button className='text-[16px] font-Poppins px-[24px] py-[16px] bg-white shadow-[0_20px_80px_rgba(51,78,123,0.3)] rounded-[10px] text-[#264373] flex items-center max-w-[174px] justify-between'> <IoMdArrowDroprightCircle className='h-[26px] w-[26px]' /> Learn more </button>
                    </div>
                    <div>
