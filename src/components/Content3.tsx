...
const Content3 = () => {
  return (
    <div className="container mx-auto mb-[90px] mt-[120px] relative z-10">
            <div className='px-[25px] lh:px-[8px]'>
                <div className="lg:flex lg:flex-row-reverse items-end">
                    <div className="basis-1/2">
                        <h1 className='text-[#262524] w-full lg:max-w-[558px] font-bold text-[35px] md:text-[60px] lg:text-[46px] leading-[140%] lg:leading-[73px] font-SportingGrotesque mb-[30px]'>Best full body workout to lose fat</h1>
