...
const Content3 = () => {
  return (
    <div className="container mx-auto h-[757px] mb-[90px]">
            <div className="grid lg:grid-cols-2 items-end h-[757px]">
                ...
                <div className="">
                    ...
                    <button className='text-[16px] font-Poppins px-[24px] py-[16px] bg-[#264373] shadow-[0_20px_80px_rgba(51,78,123,0.3)] rounded-[10px] text-white mb-[50px]'>Get started</button>
                </div>
            </div>
        </div>
  )
